...
d[c]=e,"o"===b[1]&&H(a[e]))});a._hungarianMap=d}function L(a,b,c){a._hungarianMap||H(a);var d;f.each(b,function(e,h){d=a._hungarianMap[e];d===n||!c&&b[d]!==n||("o"===d.charAt(0)?(b[d]||(b[d]={}),f.extend(!0,b[d],b[e]),L(a[d],b[d],c)):b[d]=b[e])})}function Fa(a){var b=q.defaults.oLanguage,c=b.sDecimal;c&&Ga(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&"Nenhum registo encontrado"===b.sEmptyTable&&M(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&M(a,a,
...
sNext:"Próxima",sPrevious:"Anterior"},sEmptyTable:"Nenhum registo encontrado",sInfo:"A mostrar de _START_ a _END_ de _TOTAL_ registos",sInfoEmpty:"A mostrar de 0 a 0 de 0 registos",sInfoFiltered:"(filtrado de um total de _MAX_ registos)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registos",sLoadingRecords:"A carregar...",sProcessing:"A processar...",sSearch:"Procurar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nenhum registo encontrado"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
